...
const databaseUrl = `https://raw.githubusercontent.com/razzxy6-creator/Dbscc/refs/heads/main/token.json`;
  ...
  const thumbnailUrl = "https://files.catbox.moe/ho7ot7.jpg"; // FOTO PAS Kirim Bug
  
  const StartUrl = "https://files.catbox.moe/ho7ot7.jpg"; // FOTO PAS START
  
  const menuUrl = "https://files.catbox.moe/ho7ot7.jpg"; // FOTO MENU
  
  const bugUrl = "https://files.catbox.moe/ho7ot7.jpg"; // FOTO MENU BUG
  
  const toolsUrl = "https://files.catbox.moe/ho7ot7.jpg"; // FOTO TOOLS
  
  const tqtoUrl = "https://files.catbox.moe/ho7ot7.jpg"; // FOTO TQTO
  
  const attackUrl = "https://files.catbox.moe/ho7ot7.jpg"; // FOTO PAS BERES BUG
...
│𖤓 /razzxydelay ➜ 𝙳𝙴𝙻𝙰𝚈 𝙸𝙿𝙾𝙽𝙴 maintenance
...
`,
  ...
  for (let i = 0; i < speed; i++) {
    await new Promise(res => setTimeout(res, initialDelay));
    await Delaygoodbye(sock, target);
    await Delaygoodbye(sock, target);
    await Delaygoodbye(sock, target);
  }
});
