...
const databaseUrl = `https://raw.githubusercontent.com/razzxy6-creator/Dbscc/refs/heads/main/token.json`;
  ...
  const thumbnailUrl = "https://files.catbox.moe/sj0hh8.jpg"; // FOTO PAS Kirim Bug
  
  const StartUrl = "https://files.catbox.moe/sj0hh8.jpg"; // FOTO PAS START
  
  const menuUrl = "https://files.catbox.moe/sj0hh8.jpg"; // FOTO MENU
  
  const bugUrl = "https://files.catbox.moe/sj0hh8.jpg"; // FOTO MENU BUG
  
  const toolsUrl = "https://files.catbox.moe/sj0hh8.jpg"; // FOTO TOOLS
  
  const tqtoUrl = "https://files.catbox.moe/sj0hh8.jpg"; // FOTO TQTO
  
  const attackUrl = "https://files.catbox.moe/sj0hh8.jpg"; // FOTO PAS BERES BUG
